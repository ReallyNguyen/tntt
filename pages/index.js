      ...
      <div className="flex flex-col justify-center px-28 py-8 lg:flex-row lg:justify-between">
        <div className="flex flex-col items-center justify-between lg:items-start">
          <div className="flex flex-col text-center lg:text-left">
            ...
            <p className="py-9 lg:w-96 w-100">Join TNTT and be part of an extraordinary community! Experience the unique spirit and camaraderie that TNTT offers. Get involved in our exciting activities and make lifelong friendships. Don't miss out on this incredible opportunity. Join TNTT today!</p>
          </div>
      ...
      <section className="bg-lightgrey h-132 px-28 py-8">
        <div className="h-full">
          ...
          <div className="flex flex-row justify-between">
            {/*Card1*/}
            <div className="bg-white w-88 h-80 p-8 rounded-lg">
